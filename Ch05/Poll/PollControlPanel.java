                          ...
                          implements ActionListener
{
  ...
  public PollControlPanel(PollDisplayPanel chart)
  {
    ...
    button1 = new JButton("Luke");
    button1.setPreferredSize(new Dimension(80, 30));
    button1.setToolTipText("Vote for Luke");
    button1.addActionListener(this);

    button2 = new JButton("Alex");
    button2.setPreferredSize(new Dimension(80, 30));
    button2.setToolTipText("Vote for Alex");
    button2.addActionListener(this);

    button3 = new JButton("Jake");
    button3.setPreferredSize(new Dimension(80, 30));
    button3.setToolTipText("Vote for Jake");
